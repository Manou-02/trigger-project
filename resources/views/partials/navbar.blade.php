<div class="sticky">
    <div class="header w-full flex items-center justify-between pl-10 pr-20 py-4 bg-gray-50 mt-0 z-1">
        <div class="">
            <span class="font-bold text-4xl text-blue-900 cursor-pointer">transaction bancaires</span>
        </div>
        <div class="">
